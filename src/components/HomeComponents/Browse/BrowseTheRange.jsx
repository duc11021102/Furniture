  ...
  return (
    <section className="px-8 py-14 font-body">
      <div className="text-center">
        ...
        <p className="text-sm sm:text-base md:text-lg font-medium text-gray-500 mt-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>

        <div className="flex flex-col sm:flex-row justify-center gap-6 md:gap-12 lg:gap-16 xl:gap-20 mt-10">
          <div className="sm:w-44 lg:w-60 xl:w-72 2xl:w-72">
            <img
              src={dinning}
              className="w-full h-64 sm:h-56 md:h-64 lg:h-72 2xl:h-96 object-cover rounded-xl"
            />
